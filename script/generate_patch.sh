#!/bin/bash
#
# This script generate the jaeger-operator helm chart
# It does so by pulling the upstream chart and apply patches on top

# jaeger-operator upstream git repository url
upstream_repo_url="https://github.com/jaegertracing/helm-charts.git"

# Path to helm chart in the jaeger-operator upstream repository
upstream_chart_path="charts/jaeger-operator/"

# Path to helm chart in this repository, relative to this script
local_chart_path="../helm/jaeger-operator-app/"
